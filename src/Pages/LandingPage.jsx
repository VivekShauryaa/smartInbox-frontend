    ...
    <div>
      ...
      <div className="flex flex-col p-6 bg-custom-lightblue text-center items-center justify-center gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 items-start">
            ...
            >
              ...
              <p className="text-sm text-gray-700 mb-6">
                Let AI draft replies based on email content and your unique
                preferences.
              </p>
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="bg-blue-100 p-6 rounded-2xl shadow-lh-96 h-96"
            >
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="bg-pink-100 p-6 rounded-2xl shadow-lg h-96"
            >
            ...
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="bg-green-100 p-6 rounded-2xl shadow-lg -mt-48"
            >
              <h3 className="text-xl font-bold text-green-800 mb-4">
                AI Summaries
              </h3>
              <p className="text-sm text-gray-700 mb-6">
                Get concise summaries of lengthy emails to make fast, informed
                decisions.
              </p>
              <div className="rounded-lg p-3 ">
                <div className="text-yellow-500 text-5xl">
              ...
              {[
                {
                  name: "Vivek",
                  quote:
                    "SmartInbox saved me hours every week. I can’t imagine going back!",
                ...
                },
                {
                  name: "Shaurya",
                  quote:
                    "My inbox has never been this clean. 10/10 would recommend.",
                  role: "Marketing Lead",
                  rating: 5,
                },
                {
                  name: "Ishita",
                  quote:
                    "Feels like a personal email assistant. Total game changer!",
                  role: "HR Consultant",
                  rating: 5,
                },
                {
                  name: "Raghav",
                  quote:
                    "Auto-replies that actually sound like me? Insane. I love it.",
        ...
        <section className="my-20 max-w-4xl mx-auto px-6 text-center flex justify-around gap-20">
          <div className="text-xl text-blue-600 mb-4">
            <img src={Secure} className="h-84 object-contain" />
          </div>
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-gray-700 text-md leading-relaxed">
              SmartInbox uses Google OAuth for secure Gmail access. All email
              data is encrypted and protected—your privacy is our priority.
            </p>
          </div>
        </section>
      ...
      <div className="bg-gray-100 border-t mt-20 pt-12 pb-4 px-6 text-gray-700 text-sm">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="mailto:support@smartinbox.ai"
                  className="hover:text-blue-600 transition"
                >
                  support@smartinbox.ai
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-blue-600 transition">
        ...
        <div className="mt-12 text-center text-gray-500">
          <p>
            Built with 💙 by the SmartInbox Team © {new Date().getFullYear()}{" "}
            SmartInbox. All rights reserved.
          </p>
        </div>
      </div>
    </div>
